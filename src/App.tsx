...
import { ActivateCustomerModal } from "./components/ActivateCustomerModal";
                ...
                {loading ? (
                  ...
                  <tr>
                        ...
                        {user.subscribeService.map((service) => (
                          <div key={service.subscribeServiceId}>
                            <span className="font-medium">
                              {service.serviceMenu.serviceMenuId}
                            </span>
                            {" - "}
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      ...
                      <div>
                        Estacionario: {user.customer.autoProvCountStationary}
                      </div>
                    </td>
      ...
      >
        <div className="space-y-4">
          <p className="text-sm text-gray-500">
            ¿Está seguro que desea eliminar este cliente? Esta acción no puede
            ser revertida después.
          </p>
          <div className="flex justify-end space-x-4">
            ...
            <button
              onClick={() => {
                deleteUser(user!.customer.customerId);
